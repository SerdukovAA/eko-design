 ...
 */
public class DangerClassWaterHouseDrink extends PrimaryIndicator {

    public DangerClassWaterHouseDrink(double val, InfoSource inf){
        super("Класс опасности в воде\n" +
    ...
    public int returnBall(double val) {
     ...
     if (val==1.0){
         ...
         return 3;
     }else if(val==4.0){ //значение -1 соответствует - "не установлен"
         return 4;
     }else{
